 ...
 */
async function fetchCitationCount(arxivId        , signal             )                  {
  try {
...
function scoreRecency(published        , now         = Date.now())         {
 ...
 */
function scoreVenue(primaryCategory        )         {
 ...
 */
function scoreInstitution(authors          )         {
